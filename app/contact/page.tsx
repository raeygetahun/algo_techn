    ...
    <div className="min-h-screen py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">Let's Work Together</h1>
          <p className="text-slate-300 text-lg">
            Have a project in mind? We'd love to hear about it. Fill out the form below and we'll get back to you as
            soon as possible.
          </p>
        </div>
